...
class AirspeedAtAPUpperModesEngaged(KeyPointValueNode):
    '''
    Airspeed at initial climb in which any of the following AP upper modes are first engaged:
    ...
    def can_operate(cls, available, ac_type=A('Aircraft Type'), family=A('Family')):
        return ac_type == helicopter and family and family.value == 'S92' and all_deps(cls, available)
