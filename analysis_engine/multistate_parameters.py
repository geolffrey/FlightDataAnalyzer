...
class APVerticalMode(MultistateDerivedParameterNode):
    ...
    def derive(self,
        ...
        if pitch_mode:
            ...
            if 'FLARE' in states:
                array[pitch_mode.array == 'FLARE'] = 'FLARE'
            if 'FINAL DES' in states:
                array[pitch_mode.array == 'FINAL DES'] = 'FINAL'
            if 'V/S' in states:
                array[pitch_mode.array == 'V/S'] = 'V/S'
            if 'DES' in states:
                array[pitch_mode.array == 'DES'] = 'DES'
            if 'CLB' in states:
                array[pitch_mode.array == 'CLB'] = 'CLB'
            if 'ALT' in states:
                array[pitch_mode.array == 'ALT'] = 'ALT'
            if 'ALT*' in states:
                array[pitch_mode.array == 'ALT*'] = 'ALT CAPT'
            if 'G/S' in states:
                array[pitch_mode.array == 'G/S'] = 'GS'
            if 'G/S*' in states:
                array[pitch_mode.array == 'G/S*'] = 'GS CAPT'
    ...
    def derive(self, flap=M('Flap'), slat=M('Slat'), flaperon=M('Flaperon'),
        ...
        if frame_name == 'E170_EBD_047' and approach_slices is not None:
            ...
            for approach_slice in approach_slices:
                array[approach_slice][array[approach_slice] == 16] = 32
